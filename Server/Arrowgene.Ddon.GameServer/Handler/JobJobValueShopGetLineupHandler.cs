...
namespace Arrowgene.Ddon.GameServer.Handler
{
    public class JobJobValueShopGetLineupHandler : GameRequestPacketHandler<C2SJobJobValueShopGetLineupReq, S2CJobJobValueShopGetLineupRes>
    {
        ...
        {
            var lineup = Server.AssetRepository.JobValueShopAsset
                .Where(x => x.Item1 == packet.JobId)
                .Select(x => x.Item2);
            ...
            return new S2CJobJobValueShopGetLineupRes()
            {
                ...
                JobValueShopItemList = Shop.CombatGearShopFilter.FilterJobValueLineup(
                    lineup,
                    Server.AssetRepository,
                    Server.GameSettings.GameServerSettings.RemoveCombatGearFromShops)
            };
        }
    }
}
