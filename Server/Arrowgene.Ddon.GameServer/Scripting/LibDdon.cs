...
namespace Arrowgene.Ddon.GameServer.Scripting
{
    public class LibDdon
    {
        ...
        /// <summary>
        /// Job level for EXP penalties and automatic kill EXP when level-sync EXP adjustment is enabled.
        /// </summary>
        public static uint GetEffectiveJobLevelForExp(CharacterCommon character, uint stageId)
        {
            return Server.LevelSyncManager.GetEffectiveJobLevelForExp(character, stageId);
        }
