...
namespace Arrowgene.Ddon.GameServer.Characters
{
    public class JobOrbUnlockManager
    {
        ...
        /// <summary>
        /// Enumerates every EX custom skill defined in the job orb trees, regardless of whether the
        /// character has unlocked the corresponding orb element. Used to grant all EX skills up front
        /// when the "UnlockAllSkillsAtLevelOne" setting is enabled.
        /// </summary>
        public IEnumerable<CustomSkillId> GetAllExSkills()
        {
            return GetAllUpgrades()
                .SelectMany(x => x.Value
                    .Where(y => y.IsCustomSkill() && y.CustomSkillId.IsEx())
