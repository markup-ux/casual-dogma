...
namespace Arrowgene.Ddon.GameServer.Characters
{
    public class OrbUnlockManager
    {
        ...
        /// <summary>
        /// Returns the total amount of augment cost (augment "slots") that can be obtained
        /// from the Dragon Force Augmentation tree, i.e. the maximum possible AbilityCost gain.
        /// </summary>
        public static uint GetMaxAbilityCostUpgrade(CharacterCommon character)
        {
            var upgrades = character is Character ? gPlayerDragonForceUpgrades : gPawnDragonForceUpgrades;
            return upgrades.Values
                .Where(x => x.GainType == OrbGainParamType.AbilityCost)
                .Aggregate(0u, (total, x) => total + x.Amount);
        }
