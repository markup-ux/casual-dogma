...
public interface IDatabase
{
    ...
    bool InsertIfNotExistsNormalSkillParam(uint commonId, CDataNormalSkillParam normalSkillParam, DbConnection? connectionIn = null);
    ...
    List<RevivalRechargePending> SelectRevivalRechargePending(uint characterId, DbConnection? connectionIn = null);
    bool InsertRevivalRechargePending(uint characterId, RevivalRechargeType type, long expiresAtUnix, DbConnection? connectionIn = null);
    bool DeleteRevivalRechargePending(long id, DbConnection? connectionIn = null);
    ...
    // Supply caches
    List<SupplyCache> SelectAllSupplyCaches(DbConnection? connectionIn = null);
    long InsertSupplyCache(SupplyCache cache, DbConnection? connectionIn = null);
    bool UpdateSupplyCacheTimestamp(long cacheId, DateTime updated, DbConnection? connectionIn = null);
    bool UpdateSupplyCachePosition(SupplyCache cache, DbConnection? connectionIn = null);
    bool UpsertSupplyCacheItem(long cacheId, ushort slot, SupplyCacheItemData itemData, DbConnection? connectionIn = null);
    bool DeleteSupplyCacheItem(long cacheId, ushort slot, DbConnection? connectionIn = null);
    bool DeleteSupplyCache(long cacheId, DbConnection? connectionIn = null);
    void DeleteAllSupplyCaches(DbConnection? connectionIn = null);
