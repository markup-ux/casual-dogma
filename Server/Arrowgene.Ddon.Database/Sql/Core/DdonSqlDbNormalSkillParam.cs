...
public partial class DdonSqlDb : SqlDb
{
    ...
    public override bool InsertIfNotExistsNormalSkillParam(uint commonId, CDataNormalSkillParam normalSkillParam, DbConnection? connectionIn = null)
    {
        bool result = false;
        ExecuteQuerySafe(connectionIn, connection => { result = InsertIfNotExistsNormalSkillParam(connection, commonId, normalSkillParam); });
        return result;
    }
